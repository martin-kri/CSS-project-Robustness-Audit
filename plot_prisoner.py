...
# Mengel (2018) Payoffs (21 Unique Matrices)
PAYOFFS = [
...
for model in models:
    for prompt in prompts:
        for (a, b, c, d) in PAYOFFS:
            file_path = f"Prisoners_Dilemma_{model}_payoffs_{a}_{b}_{c}_{d}_{prompt}_temp1.0.csv"
...
sns.despine()
plt.savefig("Prisoners_Dilemma_Strategies.pdf", dpi=300, bbox_inches='tight')
print("Graph saved successfully as 'Prisoners_Dilemma_Strategies.pdf'\n")