...
# float16 here, bfloat16 in the other scripts. Checked Gemma's output under
# float16 for empty/malformed responses (see ulti_gemma-empty.py) - none found.
...
for idx, (temp, offer, p_type) in enumerate(combinations, 1):
    ...
    file_path = f"ultimatum_game-data/Ultimatum_game_{output_name}_{p_type}_offer{offer}_temp{temp}.csv"
