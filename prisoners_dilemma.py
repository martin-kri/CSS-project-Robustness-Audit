...
# ── Mengel (2018) Payoff Matrices (a, b, c, d) NOTE - tuple (250, 15, 750, 85) is present 2 times ───────────────────────
PAYOFFS = [
...
for temp in TEMPERATURES:
    for (a, b, c, d) in PAYOFFS:
        for p_type in PROMPT_TYPES:
            ...
            file_path = f"Prisoners_Dilemma_{output_name}_payoffs_{a}_{b}_{c}_{d}_{p_type}_temp{temp}.csv"
            ...
            with tqdm(total=num_iter, desc=f"Generating") as pbar:
